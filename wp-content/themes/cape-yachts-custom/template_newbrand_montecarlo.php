...
<div id="navbox">
    ...
    RESOURCES</li>
		...
		<!--<li><a href="#facts">&raquo; Fun Facts about Monte Carlo</a></li>
		<li><a href="#social">&raquo; Social Media</a></li>
		<li><a href="#specs">&raquo; Download Specs</a></li>-->
		<li><a href="../brokerage-inventory/?type=Power&makemodel=monte+carlo&minprice=&maxprice=&minyear=&maxyear=&minlength=&maxlength=&SimpleSearch=Search+>&sort=lengthdesc">&raquo; See our Inventory</a></li>
	</ul>
...
<!-- Section #1 -->
<section id="monte-carlo-motorboats" data-speed="4" data-type="background">

	<div class="content-area newmodel">
	
		<img src="<?php bloginfo( 'template_directory' ); ?>/images/anchor-dark.png">

		<h2 class="newmodel-title">MONTE CARLO MOTORBOATS</h2>

		<?php
		$my_id = 362;
		$post_id_362 = get_post($my_id);
		$content = $post_id_362->post_content;
