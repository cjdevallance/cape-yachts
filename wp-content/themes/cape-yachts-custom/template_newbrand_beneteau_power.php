<?php
/*
Template Name:  New Beneteau Power
*/
get_header(); ?>
...
<div id="navbox">
    ...
    RESOURCES</li>
		...
		<li><a href="../brokerage-inventory/?type=Power&makemodel=beneteau&minprice=&maxprice=&minyear=&maxyear=&minlength=&maxlength=&SimpleSearch=Search+>&sort=lengthdesc">&raquo; See our Inventory</a></li>
	</ul>
...
<section id="beneteau-power" data-speed="4" data-type="background">
    ...
    <div class="content-area newmodel">
		...
		<h2 class="newmodel-title">BENETEAU POWER</h2>
    
		<?php
		$my_id = 57;
		$post_id_57 = get_post($my_id);
		$content = $post_id_57->post_content;
    ...
    <div class="content-area newmodel">
        ...
        <div class="main-model-links">
            <a href="#gran-turismo"><img src="<?php bloginfo( 'template_directory' ); ?>/images/new-gran-preview.jpg"><br>
            GRAN TURISMO</a>
        </div>
        
        <div class="main-model-links">
            <a href="#swift-trawler"><img src="<?php bloginfo( 'template_directory' ); ?>/images/new-swift-preview.jpg"><br>
            SWIFT TRAWLER</a>
        </div>
        
        <div class="main-model-links">
            <a href="#barracuda"><img src="<?php bloginfo( 'template_directory' ); ?>/images/new-barracuda-preview.jpg"><br>
            BARRACUDA</a>
        </div>
...
<section id="gran-turismo">
	...
	<div class="content-area newmodel">
		...
		<h2 class="newmodel-title">GRAN TURISMO</h2>
		...
		<?php query_posts("cat=15&posts_per_page=100&orderby=title&order=ASC"); ?>
		...
		<div class="video-container">
			<iframe width="500" height="280" src="//www.youtube.com/embed/ocKfvIwHjZE" frameborder="0" allowfullscreen></iframe>
		</div>
...
<!-- Section #3 -->
<section id="swift-trawler" data-speed="7" data-type="background">

	<div class="content-area newmodel">

		<img src="<?php bloginfo( 'template_directory' ); ?>/images/anchor-dark.png">

		<h2 class="newmodel-title">SWIFT TRAWLER</h2>

		<?php
		$my_id = 71;
		$post_id_71 = get_post($my_id);
		$content = $post_id_71->post_content;
		$content = apply_filters('the_content', $content);
		$content = str_replace(']]>', ']]>', $content);
		echo $content;
		?>
		
		<?php query_posts("cat=6&posts_per_page=100&orderby=title&order=ASC"); ?>
		...
		<div class="video-container">
			<iframe width="500" height="280" src="//www.youtube.com/embed/RiMQf5O25NI" frameborder="0" allowfullscreen></iframe>
		</div>
...
<!-- Section #4 -->
<section id="barracuda">

	<div class="content-area newmodel">
	
		<img src="<?php bloginfo( 'template_directory' ); ?>/images/anchor-dark.png">
        
		<h2 class="newmodel-title">BARRACUDA</h2>

		<?php
		$my_id = 73;
		$post_id_73 = get_post($my_id);
		$content = $post_id_73->post_content;
		$content = apply_filters('the_content', $content);
		$content = str_replace(']]>', ']]>', $content);            
		echo $content;
		?>
		
		<?php query_posts("cat=5&posts_per_page=100&orderby=title&order=ASC"); ?>
		...
		<div class="video-container">
			<iframe width="500" height="280" src="//www.youtube.com/embed/7prkgFzwIYY" frameborder="0" allowfullscreen></iframe>
		</div>
