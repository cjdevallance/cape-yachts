...
//		1. Fill out basic info about the brokerage below
			...
			$brokername = "Cape Yachts"; // Name of the Broker ex: "Pee Wee Herman's Yacht Sales"
			$brokeremail = "info@capeyachts.com,qadominionmarinemedia@gmail.com"; // Email that leads are sent to ex: "p.herman@yachtworld.com"
			$errorsemail = "xml-errors@yachtworld.com"; // Email that error messages are sent to, use your addy during the build then insert the following when live "xml-errors@yachtworld.com"
			$brokerphonenumber = "508-994-4444"; // Phone number of the brokerage
			$rootdirectoryurl = "http://cape-yachts.com/"; // URL to the root of the site ex: "http://65.213.231.100/~wizard/superfunwebsiteurl.com/"    ** MUST have "/" at the end. **
			$fulldirectoryurl = "http://cape-yachts.com/wp-content/themes/cape-yachts-custom/"; // FULL url to the wordpress directory ex: "http://65.213.231.100/~wizard/superfunwebsiteurl.com/wp-content/themes/light-clean-blue/"    ** MUST have "/" at the end. **
            $absolutepath = "/home/wizard/public_html/cape-yachts.com/wp-content/themes/cape-yachts-custom/"; // enter the absolute path to your theme folder ex: "/home/wizard/public_html/superfunwebsiteurl.com/wp-content/themes/light-clean-blue/"   
...
//      3. Create a new database for the broker if they do not previously have one and fill out variables below 
			...
			$databasename = "wizard_capeyachts"; // Name of the Database ex: "xml_sample"
...
//		5. Create a new event in Provisioning and fill out variable below
			...
			$boatfeed = "https://services.boatwizard.com/bridge/events/d2e64abe-f389-490f-b96d-9fa87b24a4f3/boats?status=on"; // Feed from boatwizard ex: https://services.boatwizard.com/bridge/events/4029c334-5d83-4bcc-b3c1-fbcabb0e4b11/boats?status=on
