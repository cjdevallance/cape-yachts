...
public $Username = "wizard_capeyacht";
public $Password = "CP37@cts!";
public $Database = "wizard_capeyachts"; 
			...
			{ 	
				if($record->VehicleRemarketingBoatLineItem->SalesStatus != "Delete"){
					...
					if($record->VehicleRemarketingBoatLineItem->VehicleRemarketingBoat->TotalEnginePowerQuantity){
						$HorsePower = $record->VehicleRemarketingBoatLineItem->VehicleRemarketingBoat->TotalEnginePowerQuantity;
						$HorsePowerUnit = $record->VehicleRemarketingBoatLineItem->VehicleRemarketingBoat->TotalEnginePowerQuantity[0]->attributes();
					}
					...
					if ($result == 1){
						...
						//Declare and Clear Variables
						$EngineMake = $EngineModel = $EngineYear = $EngineFuel = $EngineNo = $TotalPower = $TotalPowerUnit = $PropellerType = $EngineHours = $EngineTankMaterial = "";
						$EngineNo = 0;
						...
						if ((string) $processtank->TankUsageCode == "Fuel"){
								if($processtank->TankMaterialCode){
									$EngineTankMaterial = $processtank->TankMaterialCode;
								}
						}
						...
						EngineTankMaterial = '$EngineTankMaterial',
