...
$msg .= "This is a message submitted from the Customer References Form on Cape Yachts \n\n";
...
if($boatname){
	$msg .= "Boat Name: \t $boatname \n";
}

if($boattype){
	$msg .= "Boat Type: \t $boattype \n";
}
...
if ( (false !== strpos($reference,'sent')) || (false !== strpos($reference,'senthome')) ){
  $url.="&sentreferences=yes#referencesanchor";
} else {
  $url.="?sentreferences=yes#referencesanchor";
}
