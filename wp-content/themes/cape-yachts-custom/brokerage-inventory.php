...
$searchurl = $rootdirectoryurl . "brokerage-inventory/";
...
<div id="shadow-wrapper">
	...
	<div id="content_container-inventory">
		...
		<div id="container">
			...
			<div class="main-page-copy">
				<?php
                $my_id = 121;
                $post_id_121 = get_post($my_id);
                $content = $post_id_121->post_content;
			...
			<div class="xml-search-form-container">	
                ...
                <form name="search" class="search-form" action="<?php echo $searchurl;?>" method="get">
                ...
                <div class="search-button-container">
                    <input type="submit" name="SimpleSearch" value="Search >" class="search-button">
                </div>
                
                </form><!-- Ends TOP-SEARCH-FORM -->

				<!-- END SEARCH BOX -->

			</div>
			
			<div class="pls-button">Can't find what you're looking for?</div>
			
			<div class="pls-button-container">
				<a class="search-button" href="<?php bloginfo( 'url' ); ?>/co-brokerage-inventory/?slim=pp296476&lineonly&ps=20&lineonly">Search Co-brokerage Listings ></a>
			</div>
			...
			<div id="sort">
            	...
            	<form name="sortandfilter" action="<?php echo $searchurl;?>" method="get">
				...
				</form><!-- Ends SORT AND FILTER form -->
			...
			<div id="boat-content">
				...
				<div id="search-results">
					...
					while($info = $db->db_rs($data_p)) { 
						...
						$NewUrlContent = $info['Make'] . '-' . $info['Model'];
						$NewUrlContent = str_replace(".", "", $NewUrlContent);
						$NewUrlContent = str_replace(",", "", $NewUrlContent);
						$NewUrlContent = str_replace("/", "-", $NewUrlContent);
						$NewUrlContent = str_replace(" ", "-", $NewUrlContent);
						echo "<a href=\"" . $rootdirectoryurl . "boat-details/" . $info['Year'] . "-" . $NewUrlContent . "/" . $info['BoatID'] . "\">";
					...
					//Create H2 tag with Make and Model
						echo "<h3><a href=\"" . $rootdirectoryurl . "boat-details/" . $info['Year'] . "-" . $NewUrlContent . "/" . $info['BoatID'] . "\"><span class=\"brand\">" . $info['Make'] . "</span> <span class=\"fn\">" .$info['Model'] . "</span></a></h3>";
					//Print Boat Details
						echo "<div id=\"details\">";
					...
					if ($info['LocationCity'] != "Unknown"){
						...
						echo "</div>";
						echo "<div class=\"view-button\"><a href=\"" . $rootdirectoryurl . "boat-details/" . $info['Year'] . "-" . $NewUrlContent . "/" . $info['BoatID'] . "\" title=\"" .$info['Make'] . " " . $info['Model'] . " for sale\">View Details ></a></div>";
						echo "</li>";
						}
					}?>
					</ul>
