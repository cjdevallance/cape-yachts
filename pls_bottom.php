...
<div id="content">
	...
	if (($_SERVER["HTTP_HOST"]=="www.cape-yachts.com" || $_SERVER["HTTP_HOST"]=="cape-yachts.com" || $_SERVER["HTTP_HOST"]=="10.93.193.55" || $_SERVER["HTTP_HOST"]=="localhost" || $_SERVER["HTTP_HOST"]=="boatwizardwebsolutions.com" || $_SERVER["HTTP_HOST"]=="www.boatwizardwebsolutions.com" || $_SERVER["HTTP_HOST"]=="boatwizardwebsolutions.com") && $strStyleSheet!="" && $strIframe!="")
	{
...
//		$strBackLinkClass="backLink";
		...
		// Remove comment of following line to hide Full specifications Available icon from listing.
		...
		// Remove Video icon at bottom
		$pageHTML=str_replace("<img src=\"http://newimages.yachtworld.com/images/video_camera_small.jpg\" alt=\"video brochure\" border=0>=Video&nbsp;Brochure", " ", $pageHTML);
		$pageHTML=str_replace("video_camera_small.jpg", "images/spacer.png", $pageHTML);
		$pageHTML=str_replace("<img src=\"http://newimages.yachtworld.com/images/images/spacer.png\" alt=\"video brochure\" border=0>=Videos", " ", $pageHTML);
		...
		$pageHTML=str_replace("><b>Boats</b></a>","style=\"text-align: right;\"><b>Type Of Boat</b></a>",$pageHTML);
		...
		$pageHTML = str_replace("<a href=\"search_fyi.php?rPage=\" class=\"backLink\">","<a href=\"javascript:history.back(0);\" class=\"backLink\">",$pageHTML);
...
", "", $pageHTML);
		...
		$pageHTML=str_replace("http://www.yachtworld.com/fyi/email.cgi?url=","../contact-us/?url=" , $pageHTML);	
		
		if(!$_GET['boat_id']){
			if($_GET['searched']){
				print "<br><div id=\"boatTitle\"><h3>Your Search Results</h3></div>";
			}		
			else {
				print "<br><div id=\"boatTitle\"><h3>Worldwide Inventory</h3></div>";
			}
		}
        ...
        <?php
        	...
        	$pageHTML = str_replace("--replace--text--with--link--", $boat_model_text . " (Boat ID: " . $_GET['boat_id'] . ") " . "", $pageHTML);
		?>
