...
<link href="capeyachts_search_print.css" rel="stylesheet" type="text/css">
...
<img style="text-align: center; margin: 0px auto; display: block;" src="logo-capeyachts-print.jpg" alt="Cape Yachts">

<div id="content">
<?php 
	if (($_SERVER["HTTP_HOST"]=="www.cape-yachts.com" || $_SERVER["HTTP_HOST"]=="cape-yachts.com" || $_SERVER["HTTP_HOST"]=="localhost" || $_SERVER["HTTP_HOST"]=="10.93.193.55" || $_SERVER["HTTP_HOST"]=="www.boatwizardwebsolutions.com" || $_SERVER["HTTP_HOST"]=="www.boats-search.com" || "boatwizardwebsolutions.com"))
	{
...
$imgPath="<a href=\"/privatelabel/listing/pl_boat_detail_handler.jsp?slim=$pp&units=Feet&boat_id=$idNumber&back=/privatelabel/listing/cache/pl_search_results.jsp?slim=$pp&sm=3&is=All&cit=true&searchtype=buy\"><img src=\"http://newimages.yachtworld.com/".$imgPath.$idNumber."_".$match[0]."_thumb.jpg?".time()."\" border=\"0\" style=\"max-width: 100px;\" onmouseover=\"showtrail(this.src);\" onmouseout=\"hidetrail();\" /></a>"; 
	...
	$pageHTML=str_replace("<!-- /opt/weblogic/waeyw/ywcluster/public_html/broker_pages/capeyachts/boats.header.html:/opt/weblogic/waeyw/ywcluster/public_html/broker_pages/capeyachts/boats.footer.html:-->","",$pageHTML);
...
//	$pageHTML=str_replace("<table border=\"0\"","border=\"1\"",$pageHTML);
	...
	// the above expression is tooo bad, but ok for the time being, couldn't think of any other way which worked. 
